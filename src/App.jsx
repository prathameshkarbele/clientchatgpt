import ChatgptBody from "./Componant/ChatgptBody";
import ChatgptInput from "./Componant/ChatgptInput";
...
function App() {
  ...
  const sendMeassage = async (message) => {
  ...
  return (
    <div className="bg-[#1A232E] h-screen py-6 relative sm:px-16 px-12 text-white overflow-hidden flex flex-col justify-between align-middle">
      ...
      <div className="w-full max-w-4xl min-w-[20rem] self-center">
        <ChatgptInput sendMeassage={sendMeassage} loading={mutation.isLoading}/>
      </div>
    </div>
  );
}
...
export default App;
 ...
 //chat={chat}
 //sendMeassage={sendMeassage} loading={mutation.isLoading}